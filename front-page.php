...
<div class="homepage-header">
    <div class="container">
        <div  class="homepage-header__wrapper">
            ...
            <div data-aos="fade-right" class="homepage-header__title mont">
                <?php echo $block1['title'] ?>
            </div>
            <div  data-aos="fade-right" data-aos-delay="100" class="homepage-header__subtitle">
                <?php echo $block1['subtitle'] ?>
            </div>
            <a data-aos="fade-in" data-aos-delay="200"  href="<?php echo $block1['btn_link'] ?>" class="btn-orange homepage-header__btn">
                <span>
    ...
    <div class="container">
        <div class="introducing-block__wrapper">
            ...
            <div class="introducing-block__right">
                <div data-aos="fade-left" class="introducing-block__title mont">
                    <?php echo $block2['title'] ?>
                    
                </div>
                <div data-aos="fade-left"  data-aos-delay="100" class="introducing-block__text">
...
<div class="home-grey-block">
    <div class="container">
        <div class="home-grey-block__wrapper">
            ...
            <a  data-aos="fade-in"  href="<?php echo $block2['btn_link'] ?>" class="btn-orange home-grey-block__btn">
                <span>
...
<div class="slider-home">
    <div class="container">
        <div data-aos="fade-down" class="slider-home__title mont">
            <?php echo $block3['title'] ?>
        </div>
        <div data-aos="fade-down" data-aos-delay="100"  class="slider-home__subtitle">
...
<div class="order-block">
    <div class="container">
        <div class="order-block__wrapper">
            <div  data-aos="fade-right"  class="order-block__img">
                <img src="<?php echo $block4['image']['url'] ?>" alt="">
            </div>
            <div class="order-block__right">
                <div data-aos="fade-left"   class="order-block__text mont">
                    <?php echo $block4['text'] ?>
                </div>
                <a data-aos="fade-in"  data-aos-delay="100"  href="<?php echo $block4['btn_link'] ?>" class="btn-orange order-block__btn">
                    <span>
...
<div class="work-block">
    <div class="container">
        <div  data-aos="fade-down"   class="work-block__title mont">
            <?php echo $block5['title'] ?>
        </div>
        <div class="work-block__wrapper">
            <div class="how-block">
                <div  data-aos="fade-left"   class="how-block__text">
                    <?php echo apply_filters('the_content',$block5['text']) ?>
                </div>
                <div  data-aos="fade-right"   class="how-block__img">
                    <img src="<?php echo $block5['image']['url'] ?>" alt="">
                </div>
            </div>
            <div  data-aos="fade-in" class="work-block__center-text">
                <?php echo $block5['subtitle'] ?>

                
            </div>
            <div class="boost-block">
                <div  data-aos="fade-down" class="boost-block__title mont">
                    <?php echo $block6['title'] ?>
                </div>
                <div class="boost-block__wrapper">
                    <div  data-aos="fade-right"  class="boost-block__img">
                        <img src="<?php echo $block6['image']['url'] ?>" alt="">
                    </div>
                    <div  data-aos="fade-left" class="boost-block__list">
                ...
                <a  data-aos="fade-in"  href="<?php echo $block6['btn_link'] ?>" class="boost-block__btn btn-orange">
                    <span>
...
<div class="how-much">
    <div class="how-much__wrapper">
        <div class="how-much__left">
            <div  data-aos="fade-right" class="how-much__title mont">
                <?php echo $block7['title'] ?>
            </div>
            <div  data-aos="fade-right" data-aos-delay="100"  class="how-much__text">
...
<div class="boost-nettec">
    <div class="container">
        <div class="boost-nettec__wrapper">
            <div  data-aos="fade-right" class="boost-nettec__img">
                <img src="<?php echo $block8['image']['url'] ?>" alt="">

            </div>
            <div class="boost-nettec__right">
                <div  data-aos="fade-left"  class="boost-nettec__title mont">
                    <?php echo $block8['title'] ?>

                </div>
                <div  data-aos="fade-left" class="boost-nettec__text">
                    <?php echo apply_filters('the content', $block8['text']) ?>
                    <p>                       
                    </p>
                </div>
                <a  data-aos="fade-in" href="<?php echo $block8['btn_kink'] ?>" class="boost-nettec__btn btn-orange">
