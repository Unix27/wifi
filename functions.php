...
function theme_name_scripts() {
	...
	wp_enqueue_style( 'frontend', get_stylesheet_directory_uri() . '/css/frontend.css' );
	...
	wp_enqueue_script( 'aos',"https://unpkg.com/aos@next/dist/aos.js", true );
	...
	wp_enqueue_script( 'frontend',get_stylesheet_directory_uri() ."/js/frontend.js", true );
